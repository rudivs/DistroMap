...
<qgis version="1.9.0-Master" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
    ...
    <symbols>
      <symbol outputUnit="MM" alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="color" v="255,148,40,255"/>
          <prop k="color_border" v="255,148,40,255"/>
          <prop k="offset" v="0,0"/>
  ...
  <displayfield>GRID_15MIN</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    <edittype type="0" name="GRID_15MIN"/>
    <edittype type="0" name="ID"/>
    <edittype type="0" name="POINTCNT"/>
  </edittypes>
  <editform></editform>
