...
# translation
SOURCES = distromap.py ui_distromap.py __init__.py distromapdialog.py
#TRANSLATIONS = i18n/distromap_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = distromap

PY_FILES = distromap.py distromapdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_distromap.py
